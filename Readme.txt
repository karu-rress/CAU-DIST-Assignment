...
파일 설명 및 기본적인 사항은 'README.md'에 기술되어 있습니다. (for GitHub)
...
파일 설명 및 디렉터리 구조에 대한 내용은 README.md 에 소개되어 있습니다.
...
- root 계정을 사용하지 않고 새로운 server 계정을 사용하여 꼭 필요한 권한 외 다른 권한 제거
- 계정의 비밀번호는 SHA-256으로 안전하게 암호화되어 저장됩니다.