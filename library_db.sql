...
INSERT INTO `bookinfo` VALUES (12269026,'문화권 클러스터링 기반 SNS 빅데이터 및 사용자 선호도 분석','노승민','한국항행학회논문지','','2023-05-11'),(17381916,'특허분석을 통한 빅데이터 분석 플랫폼 기술 개발 동향','노승민','한국디지털정책학회',NULL,'2023-05-11'),(22884165,'초연결시대 기술융합을 위한 사물 인터넷 기술의 특허동향 분석','노승민','한국정보통신학회논문지','admin','2023-05-08'),(1226902601,'RFID 표준특허 데이터 분석을 통한 RFID 기술 동향','노승민','한국항행학회논문지','admin','2023-05-11'),(9788961335324,'개념원리 미적분 (2023)','이홍섭','개념원리','','2023-05-09'),(9788970509716,'C언어로 쉽게 풀어쓴 자료구조','천인국','생능출판',NULL,'2023-05-13'),(9791130333571,'인공지능과 법','한국인공지능법학회','(주)박영사',NULL,'2023-05-09'),(9791140702794,'모두의 구글 애널리틱스4','김도연','길벗',NULL,'2023-05-11'),(9791156646198,'네트워크 해킹과 보안','양대일','한빛아카데미',NULL,'2023-05-13'),(9791157031665,'한 권으로 끝내는 스페인어 능력시험 DELE B2~C1','정기훈','동양북스','user7','2023-05-09'),(9791158392239,'모던 자바스크립트 Deep Dive','이웅모','위키북스',NULL,'2023-05-11'),(9791158393724,'시작하세요! C# 10 프로그래밍','정성태','위키북스',NULL,'2023-05-07'),(9791160505030,'모두의 네트워크','미즈구치 카츠야','길벗','karu','2023-05-11'),(9791160507676,'모던 C++ 디자인 패턴','드미트리 네스터룩','길벗',NULL,'2023-05-08'),(9791161753119,'C++17 STL 프로그래밍','야체크 갈로비치','에이콘출판사','karu','2023-05-08'),(9791162243077,'이것이 취업을 위한 코딩 테스트다 with 파이썬','나동빈','한빛미디어','karu','2023-05-11'),(9791162243664,'혼자 공부하는 머신러닝+딥러닝','박해선','한빛미디어','user7','2023-05-07'),(9791162243770,'이것이 C# 이다','박상현','한빛미디어','','2023-05-11'),(9791163034032,'Do it! 자료구조와 함께 배우는 알고리즘 입문 C 언어 편','시바타 보요','이지스퍼블리싱',NULL,'2023-05-13'),(9791163034223,'Do it! 모던 자바스크립트 프로그래밍의 정석','고경희','이지스퍼블리싱',NULL,'2023-05-09'),(9791163034254,'Do it! 깡샘의 안드로이드 앱 프로그래밍 with 코틀린','강성윤','이지스퍼블리싱','user3','2023-05-09'),(9791165921453,'어떤 개발자가 살아남는가','이경종','비제이퍼블릭',NULL,'2023-05-09'),(9791169210034,'이것이 자료구조+알고리즘이다 with C 언어','박상현','한빛미디어',NULL,'2023-05-13'),(9791169210881,'Docs for Developers 기술 문서 작성 완벽 가이드','자레드 바티 외','한빛미디어',NULL,'2023-05-11'),(9791193059005,'챗GPT & AI 31가지 실전 활용','권지선 외','앤써북','user3','2023-05-11'),(9791196395704,'친절한 SQL 튜닝','조시형','디비안',NULL,'2023-05-09');
...
-- Dump completed on 2023-05-13 14:30:44
